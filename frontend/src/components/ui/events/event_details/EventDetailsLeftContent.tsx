import { AlertCircle, CheckCircle2, Globe, Mail, Pause, User, Users, XCircle } from 'lucide-react';
    ...
    <>
      ...
      {isOrganizer && !isTrashed && (
        <div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 mt-8 md:p-8 text-left">
              <h2 className="text-lg font-bold text-slate-800">Para o Organizador</h2>
              <p className="text-slate-500 text-sm mt-1 mb-6">Gerencie o seu evento.</p>
      ...
      <div className="bg-slate-50 rounded-2xl border border-slate-200 p-6 mt-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-left shadow-inner">
